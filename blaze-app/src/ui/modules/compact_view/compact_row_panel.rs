use crate::{
    ...
    ui::{
        ...
        modules::{
            compact_view::compact_row_scrollview::render_compact_row_scrollview,
            custom_context_menu::context_state::ContextMenuKind, drag_drop_logic::drag_files,
            hot_keys::hot_keys_logic, island_n_bubble::render_island_bubble,
            row_view::rubber_band_logic::render_row_rubberband,
        },
...
pub fn compact_row_panel_frame(
    ui: &mut Ui,
    state: &mut BlazeCoreState,
    ui_state: &mut BlazeUiState,
    bottom_padding: i8,
    ...
    Frame::NONE
        ...
        .show(ui, |ui| {
            ...
            let (first, last) = (state.row_view.first_visible, state.row_view.last_visible);
