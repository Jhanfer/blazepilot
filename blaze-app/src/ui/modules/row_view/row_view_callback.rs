use crate::{
    core::{
        blaze_state::{BlazeCoreState, ViewMode},
        files::blaze_motor::motor_structs::FileEntry,
    },
    ui::{
        blaze_ui_state::BlazeUiState,
        modules::row_view::{
            render_row_panel_view::row_panel_frame, render_tags_view::tag_views, tools_view::tools,
        },
        themes::colors::*,
    },
};
use egui::{CentralPanel, Frame, Margin, Ui};
use std::sync::Arc;
