...
pub const ICON_ARROW_UP: &[u8] = include_bytes!("../assets/icons/arrow-big-up.svg");
pub const ICON_ARROW_RIGHT: &[u8] = include_bytes!("../assets/icons/arrow-big-right.svg");
pub const ICON_ARROW_LEFT: &[u8] = include_bytes!("../assets/icons/arrow-big-left.svg");
pub const ICON_SETTINGS: &[u8] = include_bytes!("../assets/icons/settings.svg");
pub const ICON_ZOOM: &[u8] = include_bytes!("../assets/icons/zoom.svg");
pub const ICON_USB: &[u8] = include_bytes!("../assets/icons/device-usb.svg");
